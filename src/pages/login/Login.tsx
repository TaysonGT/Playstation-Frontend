    ...
    <div className='min-h-screen w-full bg-[url(/src/assets/login-bg.webp)] bg-cover bg-center flex justify-center items-center text-black font-medium'>
        <div dir='rtl' className=' mx-auto p-8 bg-white border border-gray-400 rounded-md shadow-md w-[350px]'>
          ...
          <form onSubmit={handleLogin} className="flex flex-col gap-2 pb-4 w-full mt-6">
            ...
            <button type='submit' className='bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-400 focus:outline-none focus:shadow-outline-blue mt-6 duration-150'>دخول</button>
          </form>
          {newUser&& <>
