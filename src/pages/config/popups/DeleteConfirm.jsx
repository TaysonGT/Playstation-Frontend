...
const DeleteConfirm = ({currentUser, setConfirmDelete}) => {
    ...
    <div className='fixed left-[50%] top-[50%] translate-x-[-50%] translate-y-[-50%] bg-white shadow-large flex-col flex z-[102] select-none px-6 py-4'>
        ...
        <div className='flex justify-between text-white'>
            ...
            <button onClick={()=> setConfirmDelete(false)} className='bg-white hover:bg-zinc-100 shadow-large text-black px-6 py-3 rounded'>الغاء</button>
        </div>
    </div>
  )
}
