  ...
  return (
    <div className={`fixed top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] z-[102] flex items-center justify-center`}>
      <div className="bg-white rounded-lg p-8">
        ...
        <form>
          <div className="mb-4">
            <label htmlFor="productName" className="block font-semibold mb-1">الاسم:</label>
            <input
              type="text"
          ...
          <div className="mb-4">
            <label htmlFor="productQuantity" className="block font-semibold mb-1">سعر الملتي:</label>
            <input
              type="number"
