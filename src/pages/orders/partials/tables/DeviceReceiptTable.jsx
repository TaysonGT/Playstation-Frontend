    ...
    <div className="shadow-lg rounded-lg overflow-hidden grow ">
        ...
        <ul className='w-full h-full bg-white overflow-y-scroll'>
            ...
            <li key={i} className='flex items-stretch w-full'>
                <div className="py-4 px-6 border-b border-gray-200 flex-1 flex items-center bg-white">{new Date(receipt.time_ordered).toLocaleTimeString()}</div>
                ...
                <div className="py-4 px-6 border-b border-gray-200 flex-1 flex items-center">{receipt.cashier}</div>
